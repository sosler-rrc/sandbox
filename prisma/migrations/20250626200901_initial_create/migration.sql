...
-- CreateIndex
CREATE UNIQUE INDEX "UserFriend_user1Id_user2Id_key" ON "UserFriend"("user1Id", "user2Id");
...
-- AddForeignKey
ALTER TABLE "UserFriend" ADD CONSTRAINT "UserFriend_user1Id_fkey" FOREIGN KEY ("user1Id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserFriend" ADD CONSTRAINT "UserFriend_user2Id_fkey" FOREIGN KEY ("user2Id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
